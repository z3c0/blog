...
In the [last entry of this series](scraping_metallum-1.md), we covered the basics of extracting data from a web page by using the website's API. In this installment, we're going to be expanding on the script we used last time to complete the same task more efficiently.
